(function ($) {
    ...
    if ( $contributors.length ) {
        var fail = function () {
            $contributors.html('<p>This project would not be possible without the help of <a href="https://api.github.com/repos/PartFire/ecutuningtherightway/contributors">our amazing contributors</a> on GitHub.</p>');
        };
        $.ajax({
            cache: false,
            dataType: 'jsonp',
            timeout: 3000,
            type: 'GET',
            url: 'https://api.github.com/repos/PartFire/ecutuningtherightway/contributors?per_page=100'
        }).done(function (data) {
